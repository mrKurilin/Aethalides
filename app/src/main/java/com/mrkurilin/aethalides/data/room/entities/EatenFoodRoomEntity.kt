...
data class EatenFoodRoomEntity(
    ...
    companion object {
        ...
        const val TABLE_NAME = "eaten food"
        const val NAME_COLUMN_NAME = "name"
        const val KCAL_COUNT_COLUMN_NAME = "kcal count"
        const val UTC_EPOCH_SECOND_COLUMN_NAME = "UTC epoch second"
        const val EPOCH_DAY_COLUMN_NAME = "epoch day"
